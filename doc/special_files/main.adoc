...
Each release should be described in a dedicated section using the following naming convention: `myproject-0.1.2 (2017-06-22)`

The following subjections are common to help describe the changes (omit those not applicable); the text of each subsection should be unordered lists:
...
== myproject-0.2.1 (2017-06-22)
=== Added
  - Added foo functionality.

== myproject-0.1.0 (2017-06-20)
=== Highlights
  - First release.
--------

== Directory Information
These files are used to provide additional information on the use or purpose of a directory. These files are always named `+__dir_info__.txt+` and are only applicable to the containing directory. These files are formatted using AsciiDoc markup.
